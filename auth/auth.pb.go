...
func (x *RegisterRequest) GetGrpcToken() string {
	if x != nil {
		return x.GrpcToken
	}
	return ""
...
func (x *RegisterRequest) GetRegisterSource() string {
	if x != nil {
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\n" +
	"auth_token\x18\x03 \x01(\tR\tauthToken\"\xca\x01\n" +
	"\x0fRegisterRequest\x12\x1d\n" +
	"\n" +
	"grpc_token\x18\x01 \x01(\tR\tgrpcToken\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12\x14\n" +
	"\x05email\x18\x04 \x01(\tR\x05email\x12'\n" +
	"\x0fregister_source\x18\x05 \x01(\tR\x0eregisterSource\x12!\n" +
	"\fphone_number\x18\x06 \x01(\tR\vphoneNumber\"F\n" +
	"\x10RegisterResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage2z\n" +
	"\vAuthService\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponseBt\n" +
